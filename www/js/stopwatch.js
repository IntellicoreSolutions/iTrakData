angular.module('stopWatchApp', [])
    ...
    .factory('StopwatchFactory', ['$interval', '$ionicPopup', '$rootScope', function ($interval, $ionicPopup, $rootScope, timesheetService) {
        return function (options) {
            ...
            self.startTimer = function (customer) {
                ...
                if (localStorage.getItem("startTimeStorage") === null) {
                    ...
                    if (options.running === false) {
                        //startTime = new Date().getTime();
                        var startTimeStorage = new Date().getTime();
            ...
            self.stopTimer = function (selectedPhaseStopwatch, descriptionStopwatch) {
                ...
                var tableForm = {
                    ...
                    description: descriptionStopwatch,
                    startTime: startTime,
